...
function insert_yt() {
	...
	convert2mp3_btn_div.setAttribute("id","c2mp3-button-div-yt");
	convert2mp3_btn_div.setAttribute("class","yt-card");
	convert2mp3_btn_div.setAttribute("style","border-color:#CCCCCC;padding-bottom:10px;padding-top:2px;");
	...
	convert2mp3_img.setAttribute("width","36px");
	convert2mp3_img.setAttribute("height","36px");
	convert2mp3_img.setAttribute("style","float:left; padding-top: 4px; padding-left: 10px; padding-right: 5px;");
	...
	mp3_btn.setAttribute("id","convert2mp3-button-mp3-youtube");
	mp3_btn.setAttribute("class","c2mp3button");

	var mp4_btn = document.createElement("button");
	mp4_btn.setAttribute("style","margin-top:8px;margin-right:4px;");
	mp4_btn.setAttribute("id","convert2mp3-button-mp4-youtube");
	mp4_btn.setAttribute("class","c2mp3button");

	var more_btn = document.createElement("button");
	more_btn.setAttribute("style","margin-top:8px;");
	more_btn.setAttribute("id","convert2mp3-button-more-youtube");
	more_btn.setAttribute("class","c2mp3button");
	...
	var mp4_text = document.createTextNode("Download MP4");
	mp4_span.appendChild(mp4_text);

	var more_span = document.createElement("span");
	more_span.setAttribute("class","yt-uix-button-content");
	...
	c2mp3_more_box_a_m4a.setAttribute("id", "convert2mp3-button-m4a-youtube");
	...
	c2mp3_more_box_a_aac.setAttribute("id", "convert2mp3-button-aac-youtube");
	...
	c2mp3_more_box_a_ogg.setAttribute("id", "convert2mp3-button-ogg-youtube");
	...
	c2mp3_more_box_a_wma.setAttribute("id", "convert2mp3-button-wma-youtube");
	...
	c2mp3_more_box_a_flac.setAttribute("id", "convert2mp3-button-flac-youtube");
	...
	c2mp3_more_box_a_3gp.setAttribute("id", "convert2mp3-button-3gp-youtube");
	...
	if ($("#theater-background").length > 0) {
		...
		$(convert2mp3_btn_div).insertBefore("#watch-header");
	} else {
		$(convert2mp3_btn_div).insertBefore("#pla-shelf");
	}


	$("#convert2mp3-button-more-youtube").click(function() {
	...
	var c2mp3_url = "http://convert2mp3.net/addon_call.php?browser=opera&version=3-2";
  	...
  	$("#convert2mp3-button-mp3-youtube").click(function() {
	...
	$("#convert2mp3-button-mp4-youtube").click(function() {
		if (document.location.toString().indexOf("watch") != -1){
	...
	$("#convert2mp3-button-m4a-youtube").click(function() {
		if (document.location.toString().indexOf("watch") != -1){
			window.open(c2mp3_url + "&format=m4a&url=" + encodeURIComponent(document.location.toString()),'_blank');
		}
		c2mp3_box_deselect($('#convert2mp3-button-more-youtube'));
	});

	$("#convert2mp3-button-aac-youtube").click(function() {
		if (document.location.toString().indexOf("watch") != -1){
	...
	$("#convert2mp3-button-ogg-youtube").click(function() {
		if (document.location.toString().indexOf("watch") != -1){
	...
	$("#convert2mp3-button-wma-youtube").click(function() {
		if (document.location.toString().indexOf("watch") != -1){
	...
	$("#convert2mp3-button-flac-youtube").click(function() {
		if (document.location.toString().indexOf("watch") != -1){
	...
	$("#convert2mp3-button-3gp-youtube").click(function() {
		if (document.location.toString().indexOf("watch") != -1){
...
$(document).ready(function () {
	...
	if (document.location.toString().indexOf("youtube.com") != -1) {

		if ($("#theater-background").length > 0 || $("#watch-header").length > 0) {
			insert_yt();
		} else {
			waitForElement("#pla-shelf",function(){
		    	insert_yt();
			});
		}
