...
var borderValue='1px solid grey',EnableRGB=true,EnableHSL=true,useCSSValues=true,usePrevColorBG=false,showPreviousClr=true,pickEveryTime=(isWindows?true:false),bbackgroundColor='black';
...
Cr.elm("div",{},[
	...
	Cr.elm("div",{id:"defaultmode"},[
		Cr.elm("div",{class:"lbrow",id:"defrgb"},[
			Cr.elm("div",{class:"lb"},[Cr.txt("RBG:")]),
	...
	Cr.elm("div",{id:"ctrls"},[
		...
		Cr.elm("a",{title:chrome.i18n.getMessage('popOutWindow'),href:"#",class:'hilight',id:"popout"},[
			Cr.elm("img",{align:"top",src:"img/popout.png"})
		])
	])
],document.body)
